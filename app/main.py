...
def predict_death_event(age, anaemia, cret, diabetes, ejection, bp, platelets, sex, serum_creat, serum_sodium, smoking,
                        time):
    '''Function to predict survival of patients with heart failure'''
    input_data = np.array(
        [[age, anaemia, bp, cret, diabetes, ejection, platelets, sex, serum_creat, serum_sodium, smoking, time]],
        dtype=object)
...
iface = gradio.Interface(fn=predict_death_event,
                         inputs=[in_Age, in_Anaemia, in_Cret, in_Diabetes, in_Ejection, in_High_BP, in_Platelets,
                                 in_Sex, in_Serum_Creat, in_Serum_Sodium, in_Smoking, in_Time],
